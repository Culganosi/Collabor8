            ...
            <Grid item xs={3} className={classes.borderRight500}>
                <List>
                    <ListItem button key="test1">
                        <ListItemIcon>
                        <Avatar alt="test1" src="http://images6.fanpop.com/image/photos/33500000/funny-muppets-msyugioh123-33511059-638-696.jpg" />
                        </ListItemIcon>
                        <ListItemText primary="Adam"></ListItemText>
                    </ListItem>
                </List>
                <Divider />
                ...
                <List>
                    <ListItem button key="test1">
                        ...
                        <ListItemText primary="Adam">Adam</ListItemText>
                        <ListItemText secondary="online" align="right"></ListItemText>
                    </ListItem>
                    <ListItem button key="test2">
                        <ListItemIcon>
                            <Avatar alt="test2" src="https://akns-images.eonline.com/eol_images/Entire_Site/2015717/rs_600x600-150817131954-600-kermit-lipton.jpg?fit=around%7C1200:1200&output-quality=90&crop=1200:1200;center,top" />
                        </ListItemIcon>
                        <ListItemText primary="Thushara">Thushara</ListItemText>
                    </ListItem>
