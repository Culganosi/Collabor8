...
export default function UserProfile() {
  ...
  useEffect(() => {
    ...
    axios.get("/api/proposals/self").then((res) => {
                  ...
                  <CardContent>
                    ...
                    <p>
                      <div className="socialIcons">
                        {self.socialMedia && self.socialMedia.Portfolio && (
                          <Link
                        ...
                        {self.socialMedia && self.socialMedia.GitHub && (
                          <Link href={self.socialMedia.GitHub} target="blank">
                            <GitHubIcon className="svg_icons" />
                          </Link>
                        )}
                        {self.socialMedia && self.socialMedia.LinkedIn && (
                          <Link href={self.socialMedia.LinkedIn} target="blank">
                            <LinkedInIcon className="svg_icons" />
                          </Link>
                        )}
                        {self.socialMedia && self.socialMedia.Twitter && (
                          <Link href={self.socialMedia.Twitter} target="blank">
                            <TwitterIcon className="svg_icons" />
                          </Link>
                        )}
                        {self.socialMedia && self.socialMedia.Instagram && (
                          <Link
              ...
              <Item>
                ...
                <Card>
                  <CardContent>
                    ...
                    >
                      {selfActiveProposalCards.length == 0 && (
                        <h4 style={styleObj}>
                          You have no active proposals, publish one to share
                          your ideas!
                        </h4>
                      )}
                      {selfActiveProposalCards.map(
                        (activepropcard) => activepropcard
                      )}
